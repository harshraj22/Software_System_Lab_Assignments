...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.4]{turing}
		\caption{
			Sir Tim Berners-Lee received the Turing Award in the year 2016,
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.4]{turi}
		\caption{
			Edmund Melson Clarke received the Turing Award in the year
2007, for his work on Model Checking.
		}
	\end{center}
\end{figure}
}
